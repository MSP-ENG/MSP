...
import { Cpu, CheckCircle2, ArrowRight, Truck, FileCheck, CheckSquare } from 'lucide-react';
import { SEED_SERVICES } from '../../data/seedData';

export function Procurement() {
  const procurementServices = SEED_SERVICES.filter(s => s.categorySlug === 'procurement');
  ...
  return (
    <div>
        ...
        <div className="container-custom">
          ...
          <div className="max-w-3xl">
            ...
            <p className="font-body text-base sm:text-lg text-on-surface-variant mt-4 leading-relaxed">
              Technical bid evaluations (TBE), vendor fabrication auditing, on-site Factory Acceptance Testing (FAT) witnessing, and Site Acceptance Testing (SAT) protocol coordination.
            </p>
          </div>
        </div>
      </section>
              ...
              >
                ...
                <div className="mt-6 pt-4 border-t border-outline-variant">
                  <Button to="/contact" variant="outline" size="sm" className="w-full justify-between">
                    <span>Inquire for Equipment Audits</span>
      ...
      <CTASection
        title="Source Validated Pharmaceutical Equipment with Confidence"
        subtitle="We ensure your autoclaves, lyophilizers, bioreactors, and clean utilities match strict URS tolerances before dispatch."
      />
    </div>
  );
}
