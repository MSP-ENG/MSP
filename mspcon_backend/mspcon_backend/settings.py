...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-mspcon-dev-key-change-in-production')
...
# Database
# Supports dynamic switching between SQLite (local development) and PostgreSQL (production)
...
if DB_ENGINE in ('postgres', 'postgresql'):
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'mspcon_db'),
...
# CORS Configuration
# Restricts access to explicitly allowed frontend origins specified in .env
...
RATELIMIT_ENABLE = os.getenv('RATELIMIT_ENABLE', 'True').lower() in ('true', '1', 't', 'yes')
